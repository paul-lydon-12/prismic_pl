import { Article, Frontpage, Layout, Page, Project, Star, Constellation } from 'prismic-types';
...
type SupportedSeoTypes = Article | Page | Frontpage | Project | Star | Constellation;
